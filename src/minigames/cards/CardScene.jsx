...
import { drawBackdrop, CORNELIUS, ELIJAH, SAUL, DANIEL, EXODUS, JEHOSHAPHAT, BALAAM, NOAH } from './scenes'
...
const DRAWERS = { ...CORNELIUS, ...ELIJAH, ...SAUL, ...DANIEL, ...EXODUS, ...JEHOSHAPHAT, ...BALAAM, ...NOAH }
