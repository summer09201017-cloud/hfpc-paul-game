...
import { drawBackdrop, CORNELIUS, ELIJAH, SAUL, DANIEL, EXODUS, JEHOSHAPHAT, BALAAM, NOAH, JESUS } from './scenes'
...
const DRAWERS = { ...CORNELIUS, ...ELIJAH, ...SAUL, ...DANIEL, ...EXODUS, ...JEHOSHAPHAT, ...BALAAM, ...NOAH, ...JESUS }
