...
import { drawBackdrop, CORNELIUS, ELIJAH, SAUL, DANIEL, EXODUS, JEHOSHAPHAT, BALAAM } from './scenes'
...
const DRAWERS = { ...CORNELIUS, ...ELIJAH, ...SAUL, ...DANIEL, ...EXODUS, ...JEHOSHAPHAT, ...BALAAM }
