...
// 年齡旋鈕(沿用 agePrefs 跨關記憶):幼=網大+目標低+網次多+魚慢、青=網小+目標高+網次少+魚快。
export const AGE = {
  kinder: { id: 'kinder', label: '幼稚園', emoji: '🧸', sub: '大網・好抓・會語音講解', netR: 96, target: 12, casts: 11, capDeep: 22, speedMul: 0.8, speakHowto: true },
  kids: { id: 'kids', label: '兒童', emoji: '🙂', sub: '一般難度（7–12 歲）', netR: 76, target: 16, casts: 9, capDeep: 18, speedMul: 1.0, speakHowto: false },
  teen: { id: 'teen', label: '青少年', emoji: '🧑', sub: '小網・要抓更多、網次更少', netR: 60, target: 20, casts: 8, capDeep: 16, speedMul: 1.25, speakHowto: false },
}
...
export const SCRIPTURE = {
  how: '整夜勞力卻沒打著魚。耶穌說:把船開到水深之處下網!點水面就「下網」,網圈裡的魚一網打盡。依從祂的話,在水深之處撒網,把魚裝滿船。',
