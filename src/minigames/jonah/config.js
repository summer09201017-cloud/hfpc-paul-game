...
export const BALAAM = {
  ...
  angelSpeedMin: 0.47, // 使者從右往左捲動速度(0..1 寬/秒)(2026-06-14:×0.9 回調→0.47,飛慢一點、好躲)
  angelSpeedMax: 0.68, // (2026-06-14:×0.9 回調→0.68)
  spawnInterval: 0.83, // 使者出現間隔(秒)(2026-06-14:1.0→0.83,數量再×1.2;間隔越小=天使越密)
