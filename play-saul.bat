@echo off
REM Reversal Heroes - Light Hero (Saul to Paul, Acts 9) - CARD level playtest.
REM Starts the Paul dev server and opens ?demo=saul. English-only (Chinese breaks .bat).
setlocal enableextensions
title Reversal Heroes - Light Hero (Saul)
cd /d "%~dp0"

echo ============================================
echo    Light Hero - Saul to Paul (Acts 9)  -  starting...
echo ============================================
echo.
...
set "URL=http://localhost:%PORT%/?demo=saul"
echo.
echo  Game URL:  %URL%
echo.
