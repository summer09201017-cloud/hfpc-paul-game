...
3. **約拿地圖改用真實「尼尼微 → 地中海」底圖（建議，取代目前的風格化示意圖）**：用 `real-geography-board` skill / `gen-map.mjs`，在 `CITIES` 加 尼尼微、約帕、迦特希弗(約拿家鄉) 等真經緯度，地圖框設東地中海岸→美索不達米亞(約 lon 33–44°E、lat 30–38°N),他施在西邊海外用箭頭示意。教育性更高:看得出約拿被召去東邊的尼尼微、卻往西逃出海,魚後再往東去尼尼微。
