...
3. **闖關美術 / 主題對齊**：跑酷關背景目前仍是約拿的「港城」美術，可換成山路 / 城門更貼「翻山越嶺」；暴風雨難度可在 `src/minigames/jonah/config.js` 的 `STORM` 微調。更多城市闖關用 `add-challenge-station`。
