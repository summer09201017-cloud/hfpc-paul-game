...
| `football/` | `?demo=football` | (無經文)世界盃足球賽・實況版 | **憫安休閒第三彈(即時操作,牧者點名「真的運球與踢球,不要撞球方式」)**:直接操控藍隊 10 號——WASD/方向鍵跑位、貼身自動帶球(球黏腳前)、**按住空白鍵蓄力放開踢**(觸控:按住往那跑、帶球點一下往那踢);隊友對手全即時 AI(追球/帶球推進/射門/守門員沿門線撲救+解圍)、抄截有 0.5s 保護防瞬搶;🤖 AI 三檔速度/👥 雙人同機(P2=方向鍵+Enter);溫柔規則 won:true;與回合彈射版(soccer)是同題材兩玩法;PR #83;07-09 加 **Q/Shift 切換球員+隊友被堵回傳**;★07-10 使用者拍板大改:**AI 再降弱**(aiSpd 68/98/126+射門醞釀 0.9/0.55/0.3s+射門變軟)、**圓盤改小人**(有眼睛表情嘴巴,瞳孔看球、走路擺腿、進球隊笑/被進隊扁嘴;碰撞仍是圓零物理改動)、**不限時先進 N 球獲勝**(N=玩家輸入 1~10,步進器+點數字鍵入;75s 沒進球守門員累了防僵局)、輸入卡鍵三修(key 小寫化/Q 防連發+0.3s 冷卻/失焦清鍵) |
| `hoopshot/` | `?demo=hoopshot` | (無經文)投籃大賽 | **憫安休閒第四彈(側視投籃,goalkick 姊妹作)**:輪流出手——按住蓄力,力道環有「綠色甜蜜區」,區內放開=空心入網;差一點=打框看運氣(幼 60%/童青 40% 彈進)、差很多=空氣球;出手點越換越遠,三分線外進球算 3 分;**每人幾球玩家輸入(1~30,預設 8;步進器+點數字鍵入,07-10)**分高者勝;🤖 對戰阿福教練/👥 雙人同機輪流;**射手有臉(07-10)**:眼睛瞄籃時看上方、進球笑瞇眼、沒進扁嘴八字眉;溫柔規則 won:true;無經文免送審 |
| `basketball/` | `?demo=basketball` | (無經文)世界盃籃球賽 | **憫安休閒第五彈(football 姊妹作,即時運球+投籃)**:WASD 跑位、貼身自動運球、按住空白鍵蓄力放開出手——★蓄力淺=傳球(平傳可被抄)/深=投籃(拋物線奔籃框,空中不可抄,甜蜜區=空心);打框彈出=籃板球大家搶;三分線外 3 分;先到 15 分或時間到比分高者勝;🤖 AI/👥 雙人同機;溫柔規則 won:true;07-09 加 **Q/Shift 切換球員+隊友被堵回傳**;★07-10 使用者回報「重複切換/卡住不能動不能傳不能投」已修(三因:Q keydown 連發沒擋 e.repeat、Shift 大小寫卡鍵 _keys.w 永遠 true、失焦漏 keyup——修=key 小寫化+防連發 0.3s 冷卻+blur 清鍵,football 同批修)+**圓盤改小人有臉**(同 football 畫法,碰撞不變) |
| `baseball/` | `?demo=baseball` | (無經文)棒球打擊王 | **憫安休閒第六彈(時機揮棒,A+B 兩模式使用者拍板都要)**:🤖 打擊練習=阿福教練投 10 球(快速/慢速/變化球依年齡檔),球到本壘上方揮棒(空白鍵/Enter/點畫面)——完美=全壘打(3 分+飛越牆+距離)/不錯=安打(1 分)/差一點=界外/太遠=揮空,沒有三振不扣分;👥 投打對決=P1 投手(W/S 高低、A/D 球種、空白鍵投)vs P2 打者(Enter 揮),6 球攻守交換比打擊分;溫柔規則 won:true;年齡三檔=球種組合×時機窗寬窄;無經文免送審 |
