...
**已完成**：**六條旅程** + 旅程選單（保羅第一/二/三次各 20 站〔宣教接力接通〕、約拿 20 站〔全六關嵌入〕、🆕 出埃及記 22 站〔真實地理：歌珊地→紅海→西奈〕、🆕 但以理 20 站〔手繪七十年時間軸棋盤〕）、每城多題隨機抽、機會/命運卡（點牌翻牌）、嵌入式即時闖關、3D 骰子、輕 RPG（同工/裝備/頭銜）、手機橫式全螢幕、CI + 六旅程自我對戰（每條 1200 場）、已上線 https://hfpc-paul-game.netlify.app/ 。

**真正待做**（節選，詳見 roadmap.md）：① 但以理/出埃及記**題庫神學審核**（AI 草擬，牧者過目才上線）+ 從骨架到完整（卡片流程關/RPG 道具層/反思終局，設計稿在 `bible-journey-planner` skill）；② journey2 與約拿舊題庫審核收尾；③ 海路到羅馬 journey4；④ 但以理時間軸棋盤美化；⑤ 雲端存檔 / 排行榜；⑥ AI 輔助產題。
