...
**已完成**：三條旅程 + 旅程選單（第一次 20 站 / 第二次 12 站〔福音進歐洲〕/ 約拿 15 站）、每城多題隨機抽、機會/命運卡（點牌翻牌）、嵌入式即時闖關（跑酷 + 暴風雨兩個必停關）、骰子 1~6、地圖縮放、CI + 三旅程自我對戰、6 個遊戲 skill。

**真正待做**（節選）：① 第二次旅程 / 約拿旅程的**題庫神學審核**（德義老師、牧者）；② 第三次旅程 + 海路到羅馬；③ 闖關美術主題對齊、更多城市闖關；④ 同工卡牌 / 植堂計分；⑤ 雲端存檔 / 排行榜；⑥ AI 輔助產題；⑦ 正式部署 + 離線測試。
