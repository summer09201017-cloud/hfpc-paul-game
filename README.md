...
**已完成**：**七條旅程** + 旅程選單（保羅第一/二/三次各 20 站〔宣教接力接通〕、🆕 **海路到羅馬 20 站**〔徒 27–28，分支 `feat/journey4-rome`，paul3→paul4 接力＝完整保羅一生〕、約拿 20 站〔全六關嵌入〕、🆕 出埃及記 22 站〔真實地理：歌珊地→紅海→西奈〕、🆕 但以理 20 站〔手繪七十年時間軸棋盤＋巴比倫城景〕）、每城多題隨機抽、機會/命運卡（點牌翻牌）、嵌入式即時闖關、🆕 **純 React 卡片流程闖關 6 關**（金像之夢排序/牆上的字解碼/十災順序/十誡配對 + 神掌權/會幕榮光終局反思，`src/minigames/cards/`）、🆕 但以理/出埃及 **RPG 道具層**（素菜清水/開窗禱告/羔羊的血/嗎哪罐〔囤積生蟲〕…＋三友/亞倫/米利暗/約書亞/戶珥）、3D 骰子、輕 RPG（同工/裝備/頭銜）、手機橫式全螢幕、CI + 六旅程自我對戰（每條 1200 場）、已上線 https://hfpc-paul-game.netlify.app/ 。

**真正待做**（節選，詳見 roadmap.md）：① 但以理/出埃及記**題庫神學審核**（AI 草擬——含卡片關文案，牧者過目才上線；送審清單 `docs/題庫送審清單-2026-06-12.html`）；② journey2 與約拿舊題庫審核收尾；③ 海路到羅馬 journey4 **題庫審核**（骨架已完成於分支 `feat/journey4-rome`，2026-06-12 晚，7 旅程 selfplay 全綠）；④ 收集機制換皮（撿嗎哪多撿生蟲/王膳考驗——需約拿引擎 spawner 支援，與引擎端協調）；⑤ 通關證書畫面（牧師點名的下一個功能）；⑥ 雲端存檔 / 排行榜；⑦ AI 輔助產題。
