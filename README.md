...
>
> ⚽ **2026-07-09 現況（運動關系列）**：
> - 已上線：⚽ **世界盃足球賽・實況版** `?demo=football`（即時運球+蓄力踢，WASD 跑位/空白鍵踢；🤖 對戰阿福教練或 👥 雙人同機）。加上原有的射門練習 `?demo=goalkick`、回合彈射足球 `?demo=soccer`，休閒運動題材共三款。
> - 等審上線（PR #84/#85）：🏀 **投籃大賽** `?demo=hoopshot`、🏀 **世界盃籃球賽** `?demo=basketball`、⚾ **棒球打擊王** `?demo=baseball`（打擊練習＋投打對決兩模式）。足球/籃球都能 **Q 鍵切換球員**、隊友被守住會回傳。全是無經文的課間休閒關，AI 對手都是「阿福教練」。
> - 大廳（總入口）首頁已瘦身：單關卡片按書卷/故事主題收進合輯（📜創世記/🏜️出埃及/⚔️士師與列王/💬比喻與教導/🎮休閒運動），每張合輯卡標題會顯示「(有N關)」。
>
> ⭐ **2026-07-04 現況**：
> - 🎵 **音樂節奏關四連發**：`?demo=psalm100`（琴鍵下落式，詩 100）、`?demo=davidharp`（透視琴弦，撒上 16）、`?demo=miriam`（太鼓紅鼓藍鈴＋連打，出 15）、`?demo=harptoy`（**自由演奏幼兒版**——沒有錯的音，跟 davidharp 同故事兩玩法）。大廳「音樂闖關合輯」一卡收齊。
> - ✝️ **耶穌生平之旅 `?journey=jesus`**（牧師核准）：21 站聖地棋盤，玩家是無名門徒「你」；平靜風浪、五餅二魚（分出去不減反增！）兩個闖關已接，其餘先用問答、可完整玩。題庫待牧者審核，大廳卡片等全部關卡接上才點亮。
> - 🗺️ 地圖美化（海陸漸層、海岸陰影、細海岸線）＋聖地圖虛線變細緻。
>
> ⭐ **2026-06-18（晚）現況**：
