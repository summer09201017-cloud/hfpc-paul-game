@echo off
REM Reversal Heroes - Hope Hero (Elijah, 1 Kings 19) - CARD level playtest.
REM Starts the Paul dev server and opens ?demo=elijah. English-only (Chinese breaks .bat).
setlocal enableextensions
title Reversal Heroes - Hope Hero (Elijah)
cd /d "%~dp0"

echo ============================================
echo    Hope Hero - Elijah (1 Kings 19)  -  starting...
echo ============================================
echo.
...
set "URL=http://localhost:%PORT%/?demo=elijah"
echo.
echo  Game URL:  %URL%
echo.
